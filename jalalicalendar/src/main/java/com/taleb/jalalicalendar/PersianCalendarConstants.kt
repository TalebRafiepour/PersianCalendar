...
object PersianCalendarConstants {
    ...
    val MILLIS_JULIAN_EPOCH = -210866803200000L
    // Milliseconds of a day calculated by 24L(hours) * 60L(minutes) *
    // 60L(seconds) * 1000L(mili);
    val MILLIS_OF_A_DAY = 86400000L

    /**
     * The JDN of one Farvardin one; Equivalent to March 19, 622 A.D.
     */
    val PERSIAN_EPOCH: Long = 1948321

    val persianMonthNames = arrayOf("\u0641\u0631\u0648\u0631\u062f\u06cc\u0646", // Farvardin
    ...
    val persianWeekDays = arrayOf("\u0634\u0646\u0628\u0647", // Shanbeh
            "\u06cc\u06a9\u200c\u0634\u0646\u0628\u0647", // Yekshanbeh
            "\u062f\u0648\u0634\u0646\u0628\u0647", // Doshanbeh
            "\u0633\u0647\u200c\u0634\u0646\u0628\u0647", // Sehshanbeh
